...
class WXRParserXML {
	...
	public function parse( $file ) {
		$this->wxr_version = $this->in_post = $this->cdata = $this->data = $this->sub_data = $this->in_tag = $this->in_sub_tag = false; // phpcs:ignore
		$this->authors     = $this->posts = $this->term = $this->category = $this->tag = []; // phpcs:ignore
